<h1>🛒 Smart Cart AI - Full-Stack E-Commerce Website</h1>

<p>
    Smart Cart AI is a fully functional e-commerce platform built with the <strong>MERN stack</strong> (MongoDB, Express, React, Node.js). 
